        ...
        <div class="col-md-8 left">
            <div class="shipping mb-4">
                <div class="ship-wrap">
                    ...
                    <div class="address mt-3 row">
                        <div class="userc col-md-3 align-self-center">
                            <h6>Mhd Ulil Abshar</h6>
                            <p>+6281365630011 </p>
                        </div>
                        <div class="addc col-md-8 align-self-center">
                            <p>(Rumah)</p>
                            <p> lubuk ipuh Lubuk ipuh samping sd negeri 21, Kurai Taji, Nan..,</p>
            ...
            <!-- Product Summary -->
            <div class=" shipping product-sum">
                <div class="ship-wrap">
                    <div class="add-title">
                        <h5>Produk</h5>
                        <p>Dikirim dari Medan</p>

                    </div>
                    <div class="media m-4 d-flex mt-5 justify-content-between">
                        <div class="img-sec d-flex gap-3">
                    ...
                    <div class="provider mt-5 d-flex justify-content-between p-3">
                        <div class="tp d-flex gap-3 ">
                            <img src="https://dl54du30pg39i.cloudfront.net/e-commerce/icons/free-delivery.png"
                                height="30" alt="">
                            <a href="#">Pilih Jasa Pengiriman</a>
                        </div>
                        <div class="ip">
                ...
                <div class="v-top p-3">
                    ...
                    <div class="o-point  mb-3">
                        ...
                        <div class="o-wrap">
                            ...
                            <div class="o-capt">
                                <p class="text-body-secondary lh-base">Anda dapat menggunakan Otten Poin maksimum 90%
                                    dari
                    ...
                    <div class="order-summary">
                        ...
                        <div class="d-grid  mt-3 col-12 mx-auto">
                            <button class="btn " type="button">
                                <a class="btnc" href="/checkout/pembayaran">Pilih Pembayaran</a>
                            </button>
                        </div>
                    </div>
                </div>
